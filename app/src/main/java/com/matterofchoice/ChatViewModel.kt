...
//            _messageList.value += MessageModel(question, "user")
            for (i in 1..4) {
                ...
                try {
                    ...
                    val userInfo = "You are developing scenarios for an educational game for children $userGender, ($userAge years old, the language $userLanguage)  "



                    val cases =
                        // let's start with 1 situation
                        "You are developing scenarios for an educational game for children $userGender , $userAge years old. This game teaches the child how to act in different life situations and make appropriate behavioral decisions. Your task is to create a list of 1 different life situations that can occur on $userSubject Do not repeat situations or mention any possible solutions. The answer must be provided as a Kotlin list. Here is an example answer with various scenarios: [You are walking on the street with your friend and see someone throwing trash on the sidewalk. What will you do?, You went to the toy store and saw the toy you’ve wanted for a long time, but it’s out of your reach because you don’t have enough money to buy it. What will you do?, You are playing in the sandbox with your friends and building a sandcastle, but another child comes and starts destroying your castle. What will you do?]"
